<?php 
    ...
    if(isset($_POST['save'])){
        $tensach = $tentg = $nhaxuatban = $ngayxb = $sotrang = $tomtat = '';
        ...
        if(!$errors){
            $sql = "CALL themsach('$tensach','$tentg','$nhaxuatban','$ngayxb','$sotrang','$tomtat')";
            $res = mysqli_query($conn,$sql);
            if($res == true){
...
<body>
    ...
    <div class="container mt-3">
        ...
        <h2 class="text-center bg-success text-white mt-4 mb-4">THÊM SÁCH</h2>
